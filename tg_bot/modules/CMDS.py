...
def post_telegraph(bot: Bot, update: Update, args: List[str]):
    short_name = "Created By @Noob_admin"
    msg = update.effective_message # type: Optional[Message]
    telegraph = Telegraph()
...
__help__ = """
○ My Name : *Filter Bot*
○ Creator : [꧁☬⋆ТᎻᎬ༒ᏦᎥᏁᏳ༒C☢nτrͥ☢lͣlͫer⋆☬꧂](https://t.me/Noob_admin)🔰Credits : `Everyone in this journey`
○ Language : Python3
○ Library : [Pyrogram asyncio 0.16.1](https://.pyrogram.org/)
